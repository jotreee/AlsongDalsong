...
import "./MainLoginBook.css";

import $ from "jquery";
import Vara from "vara";

function MainLoginBook() {
  useEffect(() => {
          ...
          <div class="first paper">
            <div class="page front contents">
              <div class="intro">
                ...
                <button onClick={()=> console.log("ddd")}>Login</button>
              </div>
            </div>
          ...
          <div class="second paper">
            <div class="page front contents">
              ...
              <div id="vara-container">
                ...
                <button onClick={()=> console.log("ddd")}>ddd</button>
              </div>
