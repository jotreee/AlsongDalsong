        ...
        stages {
                stage('Create .env') {
                        ...
                        steps { 
                                ...
                                sh 'mkdir backend/.config_secret' 
                                
                                sh 'echo "${secrets_json}" > secretss.json'
                                sh 'cat secretss.json'
                                sh 'ls -al'
                                sh 'cp secretss.json backend/.config_secret'

                                sh 'echo "${settings_common}" > settings_common.json'
                                sh 'cat settings_common.json'
                                sh 'ls -al'
                                sh 'cp settings_common.json backend/.config_secret'
